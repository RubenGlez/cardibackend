...
class UserHasBusinessRoleService {
    constructor({ userRepository }) {
        this._userRepository = userRepository;
    }
    run({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this._userRepository.getById(id);
            if (user === null)
                throw new OutputError_1.OutputError(OutputErrorTypes_1.OutputErrorTypes.UserNotFound);
            return user.role === User_1.UserRole.Business;
        });
    }
}
exports.default = UserHasBusinessRoleService;
