...
const GetSubscriptionsUseCase_1 = __importDefault(require("../../../../../application/use-cases/subscription/GetSubscriptionsUseCase"));
...
function getSubscriptionsController(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getSubscriptionsUseCase = new GetSubscriptionsUseCase_1.default({
