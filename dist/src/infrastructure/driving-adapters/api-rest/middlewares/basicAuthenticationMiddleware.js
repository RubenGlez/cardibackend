...
const CheckBasicAuthenticationUseCase_1 = __importDefault(require("../../../../application/use-cases/auth/CheckBasicAuthenticationUseCase"));
...
function basicAuthenticationMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const checkBasicAuthenticationUseCase = new CheckBasicAuthenticationUseCase_1.default({
        ...
        try {
            ...
            const userIdFromAccessToken = yield checkBasicAuthenticationUseCase.run({
                accessToken
            });
