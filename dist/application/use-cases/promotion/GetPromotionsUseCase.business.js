...
class GetPromotionsUseCase {
    constructor({ promotionRepository, companyRepository }) {
    ...
    run({ tenantId, companyId }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const promotions = yield this._promotionRepository.getAllByCompany(companyId);
            return promotions;
        });
    }
}
exports.default = GetPromotionsUseCase;
