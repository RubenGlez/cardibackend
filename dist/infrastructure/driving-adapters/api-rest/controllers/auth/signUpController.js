...
const SignUpUseCase_1 = __importDefault(require("../../../../../application/use-cases/auth/SignUpUseCase"));
...
function signUpController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const signUpUseCase = new SignUpUseCase_1.default({
            authRepository: mongoAuthRepository,
            userRepository: mongoUserRepository,
            preferencesRepository: mongoPreferencesRepository
        });
        try {
            const authData = yield signUpUseCase.run(req.body);
            res.json(authData);
        }
        catch (e) {
            next(e);
