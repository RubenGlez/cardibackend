...
const SignUpUseCase_common_1 = __importDefault(require("../../../../../application/use-cases/auth/SignUpUseCase.common"));
...
function signUpController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const signUpUseCase = new SignUpUseCase_common_1.default({
        ...
        const { body } = req;
        try {
            const authData = yield signUpUseCase.run(body);
            res.json(authData);
        }
        catch (e) {
            next(e);
