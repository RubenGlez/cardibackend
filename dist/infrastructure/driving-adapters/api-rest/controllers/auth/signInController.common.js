...
const SignInUseCase_common_1 = __importDefault(require("../../../../../application/use-cases/auth/SignInUseCase.common"));
...
function signInController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const signInUseCase = new SignInUseCase_common_1.default({
            authRepository: mongoAuthRepository,
            userRepository: mongoUserRepository
        });
        const { body } = req;
        try {
            const authData = yield signInUseCase.run(body);
            res.json(authData);
        }
        catch (e) {
            next(e);
