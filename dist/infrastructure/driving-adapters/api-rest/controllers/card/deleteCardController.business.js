...
const DeleteCardUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/card/DeleteCardUseCase.business"));
...
function deleteCardController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const deleteCardUseCase = new DeleteCardUseCase_business_1.default({
