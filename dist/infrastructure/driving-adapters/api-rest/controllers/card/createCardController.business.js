...
const CreateCardUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/card/CreateCardUseCase.business"));
...
function createCardController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createCardUseCase = new CreateCardUseCase_business_1.default({
            cardRepository: mongoCardRepository
        });
        try {
            const { tenantId = '', body } = req;
            const card = yield createCardUseCase.run(Object.assign({ tenantId }, body));
            res.json(card);
        }
        catch (e) {
            next(e);
