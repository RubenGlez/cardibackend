...
const GetCardUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/card/GetCardUseCase.business"));
...
function getCardController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getCardUseCase = new GetCardUseCase_business_1.default({
