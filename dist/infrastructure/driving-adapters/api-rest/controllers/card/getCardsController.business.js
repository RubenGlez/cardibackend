...
const GetCardsUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/card/GetCardsUseCase.business"));
...
function getCardsController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getCardsUseCase = new GetCardsUseCase_business_1.default({
