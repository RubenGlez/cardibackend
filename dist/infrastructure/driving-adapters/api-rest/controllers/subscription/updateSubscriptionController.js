...
const UpdateSubscriptionUseCase_1 = __importDefault(require("../../../../../application/use-cases/subscription/UpdateSubscriptionUseCase"));
...
function updateSubscriptionController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updateSubscriptionUseCase = new UpdateSubscriptionUseCase_1.default({
        ...
        try {
            ...
            const subscription = yield updateSubscriptionUseCase.run(Object.assign(Object.assign({ tenantId }, req.body), { id: subscriptionId }));
