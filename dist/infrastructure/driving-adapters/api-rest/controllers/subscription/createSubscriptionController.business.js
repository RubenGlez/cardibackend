...
const CreateSubscriptionUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/subscription/CreateSubscriptionUseCase.business"));
...
function createSubscriptionController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createSubscriptionUseCase = new CreateSubscriptionUseCase_business_1.default({
