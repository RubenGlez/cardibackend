...
const GetUserUseCase_common_1 = __importDefault(require("../../../../../application/use-cases/user/GetUserUseCase.common"));
...
function getUserController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getUserUseCase = new GetUserUseCase_common_1.default({
            userRepository: mongoUserRepository
        });
        try {
            const { userId } = req.params;
            const users = yield getUserUseCase.run({ userId });
            res.json(users);
        }
        catch (e) {
            next(e);
