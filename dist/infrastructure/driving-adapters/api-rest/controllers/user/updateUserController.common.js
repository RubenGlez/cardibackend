...
const UpdateUserUseCase_common_1 = __importDefault(require("../../../../../application/use-cases/user/UpdateUserUseCase.common"));
...
function updateUserController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updateUserUseCase = new UpdateUserUseCase_common_1.default({
