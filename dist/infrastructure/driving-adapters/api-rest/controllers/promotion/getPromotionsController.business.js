...
const GetPromotionsUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/promotion/GetPromotionsUseCase.business"));
...
function getPromotionsController(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getPromotionsUseCase = new GetPromotionsUseCase_business_1.default({
