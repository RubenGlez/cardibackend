...
const DeletePromotionUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/promotion/DeletePromotionUseCase.business"));
...
function deletePromotionController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const deletePromotionUseCase = new DeletePromotionUseCase_business_1.default({
