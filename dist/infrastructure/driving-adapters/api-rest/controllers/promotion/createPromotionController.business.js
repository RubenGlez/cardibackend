...
const CreatePromotionUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/promotion/CreatePromotionUseCase.business"));
...
function createPromotionController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createPromotionUseCase = new CreatePromotionUseCase_business_1.default({
