...
const UpdateCompanyUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/company/UpdateCompanyUseCase.business"));
...
function updateCompanyController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updateCompanyUseCase = new UpdateCompanyUseCase_business_1.default({
            companyRepository: mongoCompanyRepository
        });
        try {
            const { params, tenantId = '', body } = req;
            const { companyId } = params;
            const company = yield updateCompanyUseCase.run(Object.assign({ tenantId,
                companyId }, body));
            res.json(company);
        }
        catch (e) {
