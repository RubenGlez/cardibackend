...
const CreateCompanyUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/company/CreateCompanyUseCase.business"));
...
function createCompanyController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createCompanyUseCase = new CreateCompanyUseCase_business_1.default({
            companyRepository: mongoCompanyRepository
        });
        try {
            const { tenantId = '', body } = req;
            const company = yield createCompanyUseCase.run(Object.assign({ tenantId }, body));
            res.json(company);
        }
        catch (e) {
            next(e);
