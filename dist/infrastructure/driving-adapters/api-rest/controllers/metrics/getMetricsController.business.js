...
const GetMetricsUseCase_business_1 = __importDefault(require("../../../../../application/use-cases/metrics/GetMetricsUseCase.business"));
...
function getMetricsController(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getMetricsUseCase = new GetMetricsUseCase_business_1.default({
