...
const UpdatePreferencesUseCase_common_1 = __importDefault(require("../../../../../application/use-cases/preferences/UpdatePreferencesUseCase.common"));
...
function updatePreferencesController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updatePreferencesUseCase = new UpdatePreferencesUseCase_common_1.default({
            preferencesRepository: mongoPreferencesRepository
        });
        try {
            const { params, tenantId = '', body } = req;
            const { preferencesId } = params;
            const preferences = yield updatePreferencesUseCase.run(Object.assign({ tenantId,
                preferencesId }, body));
