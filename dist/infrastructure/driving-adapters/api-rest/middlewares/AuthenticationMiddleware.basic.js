...
const CheckAuthenticationUseCase_basic_1 = __importDefault(require("../../../../application/use-cases/auth/CheckAuthenticationUseCase.basic"));
...
function AuthenticationMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const checkAuthenticationUseCase = new CheckAuthenticationUseCase_basic_1.default({
