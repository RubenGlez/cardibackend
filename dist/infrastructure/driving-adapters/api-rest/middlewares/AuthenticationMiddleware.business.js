...
const CheckAuthenticationUseCase_business_1 = __importDefault(require("../../../../application/use-cases/auth/CheckAuthenticationUseCase.business"));
...
function AuthenticationMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const checkAuthenticationUseCase = new CheckAuthenticationUseCase_business_1.default({
