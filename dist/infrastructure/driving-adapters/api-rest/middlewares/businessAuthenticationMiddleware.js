...
const CheckBusinessAuthenticationUseCase_1 = __importDefault(require("../../../../application/use-cases/auth/CheckBusinessAuthenticationUseCase"));
...
function businessAuthenticationMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const checkBusinessAuthenticationUseCase = new CheckBusinessAuthenticationUseCase_1.default({
        ...
        try {
            ...
            const userIdFromAccessToken = yield checkBusinessAuthenticationUseCase.run({
                accessToken
            });
...
exports.default = businessAuthenticationMiddleware;
